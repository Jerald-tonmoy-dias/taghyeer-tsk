...
- `/` — marketing landing (nav, hero, static chat preview)
...
**Now:** core chat + landing foundation, nav, hero, and a static chat preview.  
**Next:** landing footer, fake live message on the mock.
